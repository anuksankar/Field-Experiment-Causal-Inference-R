...
# set daily compliance value to '1' for those who have a survey entry on each day of the experiment
d <- d[ , day1 := ifelse(name %in% list('Sonia Oh', 'Lee', 'Adam Letcher', 'Tom Goter', 'Sarah Miller', 'Jamie Studwell', 'Angshuman Paul', 
                                        'Nitika', 'Anna Gibson', 'Erika', 'Patrick Hannahan', 'Steven Reilly'), 1, day1)]
d[day1 == 1, name]

d <- d[ , day2 := ifelse(name %in% list('Adam Letcher', 'Nitika', 'Sonia Oh', 'Lee',  'Chandra Shekar Bikkanur', 'Anna Gibson', 'Mihir Sathe',
                                        'Nick Webb', 'Jamie Studwell', 'Tom Goter', 'Erika', 'Stewart Jones', 'Angshuman Paul', 'Patrick Hannahan', 
                                        'Steven Reilly', 'Hema', 'Sarah Miller'), 1, day2)]
d[day2 == 1, name]

d <- d[ , day3 := ifelse(name %in% list('Erika', 'Lee', 'Nitika', 'Anna Gibson', 'Sarah Miller', 'Chandra Shekar Bikkanur','Patrick Hannahan', 
                                        'Tom Goter',  'Jamie Studwell', 'Praba Santhanakrishnan', 'Adam Letcher', 'Steven Reilly',
                                        'Phil Miller', 'Jason Tuenge', 'Linda', 'Ananya Ravi', 'Dan Rasband', 'Andrew Larimer', 'Eric Wulf', 
                                        'Annie Lane', 'Rahul', 'Liz Miller Lee', 'Victor Linguistic', 'Eugene Tang', 'Gaurav Desai', 'Tim Slade'), 1, day3)]

d[day3 == 1, name]

d <- d[ , day5 := ifelse(name %in% list('Liz Miller Lee', 'Eugene Tang', 'Victor Linguistic', 'Jason Tuenge', 'Stewart Jones', 'Dan Rasband', 'Andrew Larimer', 
                                        'Annie Lane', 'Vidya Bharathi Rajkumar'), 1, day5)]

d[day5 == 1, name]

d <- d[ , day6 := ifelse(name %in% list('Eric Wulf', 'Annie Lane', 'Jason Tuenge', 'Eugene Tang', 'Krysten Thompson', 'Dan Rasband', 'Phil Miller', 'Liz Miller Lee',                                         'Vidya Bharathi Rajkumar', 'Ananya Ravi'), 1, day6)]

d[day6 == 1, name]

d <- d[ , day7 := ifelse(name %in% list('Dan Rasband', 'Eric Wulf', 'Andrew Larimer', 'Eugene Tang', 'Krysten Thompson',  'Phil Miller', 'Annie Lane', 
                                        'Jason Tuenge', 'Ananya Ravi', 'Vidya Bharathi Rajkumar', 'Victor Linguistic',
                                        'Lee', 'Erika', 'Anna Gibson', 'Chandra Shekar Bikkanur', 'Adam Letcher', 'Anu yadav', 'Tom Goter', 'Sarah Miller',
                                        'Angshuman Paul', 'Steven Reilly', 'Nitika'), 1, day7)]
